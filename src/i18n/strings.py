...
STRINGS = {
    "en": {
        ...
        "sidebar_portability": "Take this session with you",
        "sidebar_portability_note": "Download a session file or continue from one you downloaded earlier.",
        "session_download": "Download session file",
        "session_import_label": "Continue from session file",
    ...
    "de": {
        ...
        "sidebar_portability": "Sitzung mitnehmen",
        "sidebar_portability_note": "Lade eine Sitzungsdatei herunter oder setze ein früheres Gespräch mit einer heruntergeladenen Datei fort.",
        "session_download": "Sitzungsdatei herunterladen",
        "session_import_label": "Mit Sitzungsdatei fortsetzen",
