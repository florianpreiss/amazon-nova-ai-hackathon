...
STRINGS = {
    "en": {
        ...
        "footer": "KODA provides orientation, not legal or financial advice. No data is stored. Your session is private and ephemeral.",
        "lang_toggle": "🇩🇪 Deutsch",
    },
    "de": {
        "title": "KODA",
        ...
        "footer": "KODA bietet Orientierung, keine Rechts- oder Finanzberatung. Es werden keine Daten gespeichert. Deine Sitzung ist privat.",
        "lang_toggle": "🇬🇧 English",
    },
}
