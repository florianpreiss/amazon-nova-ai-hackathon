...
STRINGS = {
    "en": {
        ...
        "sidebar_stat_agent": "Current guide",
        "sidebar_stat_messages": "Messages",
        "sidebar_stat_language": "Reply language",
        "sidebar_stat_sources": "Citations",
        "sidebar_pending": "Listening",
        "sidebar_section_focus": "Current focus",
        "sidebar_section_goals": "Your questions so far",
        "sidebar_section_identity": "Inferred from this chat",
        "sidebar_identity_hint": "Check this summary and reset the session if something looks wrong.",
    ...
    "de": {
        ...
        "sidebar_stat_agent": "Aktueller Guide",
        "sidebar_stat_messages": "Nachrichten",
        "sidebar_stat_language": "Antwortsprache",
        "sidebar_stat_sources": "Zitate",
        "sidebar_pending": "Hört zu",
        "sidebar_section_focus": "Aktueller Fokus",
        "sidebar_section_goals": "Deine bisherigen Fragen",
        "sidebar_section_identity": "Aus diesem Gespräch erkannt",
        "sidebar_identity_hint": "Prüfe diese Zusammenfassung und setze die Sitzung zurück, wenn etwas nicht stimmt.",
