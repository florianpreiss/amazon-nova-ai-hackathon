...
STRINGS = {
    "en": {
        ...
        "thinking_title": "KODA is connecting the dots",
        "thinking_body": "We're turning the parts nobody usually explains into clear next steps for you.",
    ...
    "de": {
        ...
        "thinking_title": "KODA verbindet gerade die Punkte",
        "thinking_body": "Wir ordnen gerade das, was sonst oft unausgesprochen bleibt, in klare nächste Schritte für dich.",
