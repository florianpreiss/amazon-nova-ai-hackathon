...
STRINGS = {
    "en": {
        ...
        "document_hint": "Optional: attach a document with the paperclip in the chat field.",
    ...
    "de": {
        ...
        "document_hint": "Optional: Hänge mit der Büroklammer im Chatfeld ein Dokument an.",
